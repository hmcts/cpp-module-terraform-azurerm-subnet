...
# This version file needs to be present both in module and tests directory because pre-commit hook will create tmp version lock files and complain in each place
terraform {
  required_providers {
    azurerm = {
